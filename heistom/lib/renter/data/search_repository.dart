...
class SearchRepository {
  ...
  final SearchHouseController searchHouseController =
    ...
    try {
      final response = await dio.post(
        ...
        data: {
          ...
          'checkIn':
              searchHouseController.checkInDate.value.millisecondsSinceEpoch,
          'checkOut':
              searchHouseController.checkOutDate.value.millisecondsSinceEpoch,
          'numberOfPeople': searchHouseController.peopleCount.value,
          'numberOfRoom': searchHouseController.roomCount.value,
          'amenities': searchHouseController.selectedAmenities
