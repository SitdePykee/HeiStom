...
class _BillDonePageState extends State<BillDonePage> {
  late Future<LodgingEntity> lodgingFuture;
  ...
  void initState() {
    super.initState();
    lodgingFuture = billRepository.getLodgingById(widget.bill.lodgingID!);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: FutureBuilder<LodgingEntity>(
        future: lodgingFuture,
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            return const Center(child: CircularProgressIndicator());
          }

          final lodging = snapshot.data ?? lodgingPlaceholder;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => Get.off(NavBarScreen()),
